# Week 7 — Scan and Fix Vulnerabilities with Semgrep

## Assignment Overview
Run static analysis against the provided app in `week7/` using **Semgrep**. Triage findings and remediate a minimum of 3 security issues. In your write-up, explain what issues Semgrep surfaced and how you fixed them.
...
### What you will scan
- Backend Python (FastAPI): `week7/backend/`
- Frontend JavaScript: `week7/frontend/`
- Dependencies: `week7/requirements.txt`
- Config/env (for secrets): files within `week7/`
